...
import 'package:stylesync/connections/ocr.dart';

class ColorDisplayPage extends StatefulWidget {
  final String imagePath;
  final String oriImagePath;

  ColorDisplayPage({required this.imagePath, required this.oriImagePath});
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                scanImageFromFile(context, File(widget.oriImagePath));
              },
